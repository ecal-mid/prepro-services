...
import bytes2bytes_pb2 as bytes2bytes__pb2
...
class Bytes2BytesStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Run = channel.unary_unary(
        '/Bytes2Bytes/Run',
        request_serializer=bytes2bytes__pb2.Bytes2BytesRequest.SerializeToString,
...
def add_Bytes2BytesServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Run': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=bytes2bytes__pb2.Bytes2BytesReply.SerializeToString,
      ),
  }
